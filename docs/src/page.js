    ...
    return (
      <RadiumStarter>
        {(t, s) => {
          ...
          const menuItemStyle = [s.inlineBlock, s.inverseTextColor, {marginLeft: '1.3rem'}];

          const menuItemLinkStyle = [s.inverseTextColor];
            ...
            <div>
              ...
              >
                ...
                >
                  <a
                    href="#docs"
                    style={[s.inverseTextColor, {':hover': {textDecoration: 'none'}}]}
                  >
                    &#x2304;
                  </a>
                </div>
