  ...
  render() {
    ...
    return (
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', padding: '2rem', backgroundColor: t.primaryColor }}>
          ...
          <div style={{ flexGrow: 1, flexShrink: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <img src='images/radium-starter-logo.svg' alt='Radium Starter' style={[{ flexGrow: 1, width: '100%', minWidth: 300, maxWidth: 600 }]} />
          </div>
          <div style={[{ flexShrink: 0, alignSelf: 'center' }, s.minimumLineHeight, { fontSize: '3rem' }]}>
            <a href='#docs' style={[s.inversePrimaryTextColor, { ':hover': { textDecoration: 'none' } }]}>&#x2304;</a>
          </div>
        </div>

        <div id='docs' dangerouslySetInnerHTML={{ __html: window.INJECTED_CONTENT }} style={{ margin: '0 auto', padding: '2rem 1rem', maxWidth: 800 }}/>
      </div>
    );
  }
}
